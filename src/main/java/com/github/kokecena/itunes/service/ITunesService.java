...
import com.github.kokecena.itunes.models.Result;
...
public interface ITunesService {
     ...
     * @return A Mono emitting a {@link Result} object representing the search results.
     */
    @GET("search")
    Mono<Result> search(@QueryMap Map<String, String> query);
}
